...
namespace Palmtree.Terminal
{
        ...
        : IEquatable<Color88>
    {
        ...
        private Color88(int colorCode)
        {
            if (colorCode.IsOutOfHalfClosedInterval(0, 88))
        ...
        /// </summary>
        public static readonly IReadOnlyArray<Color88> GrayScales =
            Enumerable.Repeat(80, 8)
            .Select(code => new Color88(code))
            .ToReadOnlyArray();
        ...
        /// </returns>
        public bool Equals(Color88 other)
        ...
        /// </returns>
        public static bool operator ==(Color88 left, Color88 right) => left.Equals(right);
        ...
        /// <summary>
        /// <see cref="Color88"/> 値を <see cref="int"/> 値に変換します。
        /// </summary>
        /// <param name="value">
        /// 変換する <see cref="Color88"/> 値です。
        /// </param>
        public static explicit operator int(Color88 value) => value._colorNumber;
